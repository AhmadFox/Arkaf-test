    ...
    return (
        <AuthLayout>
			...
			<div className="flex flex-col items-center gap-3 w-full max-w-[500px] mx-auto">
                <button className='w-full py-2.5 px-4 rounded-[8px] bg-[#34484F] font-semibold capitalize hover:bg-[#405861] text-white text-center ease-out duration-300'>{translate('continue')}</button>
                ...
                <button className="border border-[#DFE1E7] py-2.5 px-4 rounded-md flex items-center gap-2 text-[#272835] hover:text-white hover:bg-[#34484F] ease-in-out duration-200">
                    {translate('finishUp')}
                </button>
            </div>
