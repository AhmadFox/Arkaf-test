                                    ...
                                    >
                                        <TableRow>
                                            <TableCell sx={{ fontWeight: "400" }}>
                                                <span className="text-lg font-normal">{translate("property")}</span>
                                            </TableCell>
                                            {/* <TableCell sx={{ fontWeight: "600" }} align="center">
                                                {translate("category")}
                                            </TableCell> */}
                                            <TableCell sx={{ fontWeight: "400" }} align="center">
                                                <span className="text-lg font-normal">{translate("Status")}</span>
                                            </TableCell>
                                            <TableCell sx={{ fontWeight: "400" }} align="center">
                                                <span className="text-lg font-normal">{translate("Agent")}</span>
                                            </TableCell>
                                            {/* <TableCell sx={{ fontWeight: "600" }} align="center">
                                        ...
                                        {isLoading ? (
                                            ...
                                            getFeaturedListing.map((elem, index) => (
                                                <TableRow key={index}>
                                                    ...
                                                    <TableCell align="center">{elem.status === 1 ? <span className="rounded-full py-1.5 px-3 bg-green-100 text-green-600 border-green-600">{translate("Available")}</span> : <span className="rounded-full py-1.5 px-3 bg-[#d1e3ff] text-[#1254B7]">{translate("On Agent")}</span>}</TableCell>
                                                    <TableCell align="center" onClick={() => handleShowIntrestedUser(elem.slug_id)}>
                                                        <div className="flex gap-1 items-center justify-center">
                                                            {/* <span>
                                                                <FaRegEye size={20} />
                                                            </span> */}
                                                            <div className="border rounded-full px-3 py-2">Still Find Agent</div>
                                                        </div>
                                                    </TableCell>
