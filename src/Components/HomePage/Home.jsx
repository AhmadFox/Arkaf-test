...
import { GetAllArticlesApi, GetCountByCitysCategorisApi, GetFeturedListingsApi, GetSliderApi, getAllprojectsApi, getUserRecommendationApi } from "@/store/actions/campaign";
            ...
            <Layout>
                {sliderdata && sliderdata?.length > 0 ? (
                    isLoading ? (
                        ...
                        <section id="mainheroImage bg-dark">
                            {/* <div>
                ...
                <div style={{ marginTop: sliderdata.length > 0 ? '0' : '150px' }}>
                                            ...
                                            <div className="row" id="nearBy-Citys">
                                                <div className="col-12 col-md-6 col-lg-3" id="city_img_div">
                                                    <Link href={`/properties/city/${getNearByCitysData[1]?.City}`}>
                                                        <div className="card bg-dark text-white mb-3" id="group_card">
                                                            <Image loading="lazy" src={getNearByCitysData && getNearByCitysData[1]?.image} className="card-img" alt="no_img" id="TopImg" width={200} height={200} onError={placeholderImage} />
                                                ...
                                                <div className="col-12 col-md-6 col-lg-3" id="city_img_div">
                                                    <Link href={`/properties/city/${getNearByCitysData[2]?.City}`}>
                                                        <div className="card bg-dark text-white mb-3" id="group_card">
                                                            <Image loading="lazy" src={getNearByCitysData && getNearByCitysData[2]?.image} onError={placeholderImage} className="card-img" alt="no_img" id="TopImg" width={200} height={200} />
                                                            <div className="card-img-overlay">
                                                                <div id="city_img_headlines">
                                                ...
                                                <div className="col-lg-6" id="city_image_main_div">
                                                    <Link href={`/properties/city/${getNearByCitysData[0]?.City}`}>
                                                        <div className="card bg-dark text-white mb-3" id="cityImgTop">
                                                            <Image loading="lazy" src={getNearByCitysData && getNearByCitysData[0]?.image} className="card-img" alt="no_img" id="TopImg" width={200} height={200} onError={placeholderImage} />
                                                            <div className="card-img-overlay">
                                                                <div id="city_img_headlines">
                                                ...
                                                <div className="col-12 col-md-6 col-lg-3" id="city_img_div01">
                                                    <Link href={`/properties/city/${getNearByCitysData[3]?.City}`}>
                                                        <div className="card bg-dark text-white" id="group_card">
                                                            <Image loading="lazy" src={getNearByCitysData && getNearByCitysData[3]?.image} className="card-img" alt="no_img" id="TopImg" width={200} height={200} onError={placeholderImage} />
                                                            <div className="card-img-overlay">
                                                                <div id="city_img_headlines">
                                                ...
                                                <div className="col-12 col-md-6 col-lg-3" id="city_img_div01">
                                                    <Link href={`/properties/city/${getNearByCitysData[4]?.City}`}>
                                                        <div className="card bg-dark text-white " id="group_card">
                                                            <Image loading="lazy" src={getNearByCitysData && getNearByCitysData[4]?.image} className="card-img" alt="no_img" id="TopImg" width={200} height={200} onError={placeholderImage} />
                                                            <div className="card-img-overlay">
                                                                <div id="city_img_headlines">
                                                ...
                                                {getNearByCitysData?.slice(0, 4).map((ele, index) => (
                                                    <div className="col-12 col-md-6 col-lg-3" id="city_img_div" key={index}>
                                                        <Link href={`/properties/city/${ele?.City}`}>
                                                            <div className="card bg-dark text-white mb-3" id="group_card">
                                                                <Image loading="lazy" src={ele?.image} className="card-img" alt="no_img" id="TopImg" width={200} height={200} onError={placeholderImage} />
                                                                <div className="card-img-overlay">
                                                                    <div id="city_img_headlines">
                    ...
                    {getMostFavProperties && getMostFavProperties?.length > 0 ? (
                        <section id="most_fav">
                            <div className="container">
                                <div className="most_fav_header">
                                    <div className="mb-0 h3">{translate("mostFavProp")}</div>
                                    <div className="position-relative d-flex justify-content-center swiper-navigation-out d-none d-md-flex">
                                ...
                                <div className="mobile-headline-view">
                                    <div className="text-center h3">{translate("mostFavProp")}</div>
                                    <div className="position-relative d-flex justify-content-center swiper-navigation-out d-none d-md-flex">
                                        <div className="swiper-button-prev sw_prev_2" onClick={() => swiperRef2?.current?.slidePrev()}></div>
                                        <div className="swiper-button-next sw_next_2" onClick={() => swiperRef2?.current?.slideNext()}></div>
                                    </div>
